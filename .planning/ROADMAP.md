...
Plans:
- [ ] 02-01: Implement the network supervisor state machine and event handling boundaries
...
Plans:
- [ ] 04-01: Define storage schema, versioning rules, and persistence boundaries
...
Plans:
- [ ] 05-01: Build the HTTP service shell and static asset delivery pipeline
...
Plans:
- [ ] 07-01: Define the time model, schedule schema, and missed-job semantics
...
| 2. Wi-Fi Supervision | 0/3 | Not started | - |
